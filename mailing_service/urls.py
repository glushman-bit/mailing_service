...
urlpatterns = [
    ...
    path('message/<int:pk>/', cache_page(600)(MessageDetailView.as_view()), name='message_detail'),
    ...
    path('mailing/<int:pk>/', cache_page(600)(MailingDetailView.as_view()), name='mailing_detail'),
    ...
    # Прочие ссылки
    path('info/', cache_page(300)(TemplateView.as_view(template_name='mailing_service/info.html')), name='info'),
